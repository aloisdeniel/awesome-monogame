...
* [Monofoxe](https://bitbucket.org/gnFur/monofoxe/) - A game engine main goal of which is to greatly simplify working with Monogame and to provide basic set of tools enabling you to just _create a new project and make a damn game_ without removing low-level access to the framework.
